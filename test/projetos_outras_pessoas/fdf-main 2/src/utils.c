...
/*   Updated: 2024/10/16 14:25:01 by jpcarvalho       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//get_color function is used to get the color of the pixel
//based on the value of the pixel and the base color
//and the z_ratio
//z_ratio is the difference between the max and min value of the z axis
//base_color is the color of the pixel when the value is 0
//value is the value of the pixel
//the function returns the color of the pixel
//based on the value of the pixel
//the base color and the z_ratio
//the function uses the incrementor to calculate the new color
//of the pixel based on the value of the pixel
//the base color and the z_ratio
//the function returns the new color of the pixel
//based on the value of the pixel
//the base color and the z_ratio
//the function uses the incrementor to calculate the new color
//of the pixel based on the value of the pixel
